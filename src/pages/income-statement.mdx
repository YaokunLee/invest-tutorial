...
<figure className="flex flex-col items-center">
  <img src="/invest/income-statement/nvda-latest.png" alt="NVDA Quarterly 收入表" />
  <figcaption className="text-center text-sm text-gray-500 mt-2">英伟达（NVDA）截至 2026-2-9 的 Quarterly 收入表，数据来源：StockAnalysis</figcaption>
</figure>
...
<br />
<figure className="flex flex-col items-center">
  <img src="/invest/income-statement/nvda-gross-profit.png" alt="NVDA Gross Profit" />
  <figcaption className="text-center text-sm text-gray-500 mt-2">Revenue 减去 Cost of Revenue 得到 Gross Profit（毛利）</figcaption>
</figure>

<br />
<figure className="flex flex-col items-center">
  <img src="/invest/income-statement/nvda-gross-margin.png" alt="NVDA Gross Margin" />
  <figcaption className="text-center text-sm text-gray-500 mt-2">Gross Margin（毛利率）= Gross Profit / Revenue，英伟达最新一季度为 73.41%</figcaption>
</figure>
...
<br />
<figure className="flex flex-col items-center">
  <img src="/invest/income-statement/nvda-expense.png" alt="NVDA Operating Expenses" />
  <figcaption className="text-center text-sm text-gray-500 mt-2">英伟达三费明细：SGA、研发费用、运营费用及 Operating Income</figcaption>
</figure>
...
<br />
<figure className="flex flex-col items-center">
  <img src="/invest/income-statement/baba-marketing-expense.png" alt="阿里巴巴营销费用占比" />
  <figcaption className="text-center text-sm text-gray-500 mt-2">阿里巴巴季度营销费用占收入比例，从 13.73% 飙升至 26.84%，反映竞争加剧</figcaption>
</figure>
...
<br />
<figure className="flex flex-col items-center">
  <img src="/invest/income-statement/nvda-marketing-expense.png" alt="英伟达 SGA 费用占比" />
  <figcaption className="text-center text-sm text-gray-500 mt-2">英伟达季度 SGA 费用占收入比例，从 2.56% 降至 1.99%，竞争格局持续向好</figcaption>
</figure>
...
<br />
<figure className="flex flex-col items-center">
  <img src="/invest/income-statement/nvda-operating-income.png" alt="NVDA Operating Income to Net Income" />
  <figcaption className="text-center text-sm text-gray-500 mt-2">从 Operating Income 到 Net Income：利息、其他收支、税费的逐步扣减过程</figcaption>
</figure>
...
<br />
<figure className="flex flex-col items-center">
  <img src="/invest/income-statement/pdd-invest-income.png" alt="PDD Interest & Investment Income" />
  <figcaption className="text-center text-sm text-gray-500 mt-2">PDD 的 Interest & Investment Income（红框），Q3 2025 高达 8,565M，占税前利润的 25.7%</figcaption>
</figure>
...
<br />
<figure className="flex flex-col items-center">
  <img src="/invest/income-statement/pdd-cash.png" alt="PDD Cash & Short-Term Investments" />
  <figcaption className="text-center text-sm text-gray-500 mt-2">PDD Balance Sheet 中的现金及短期投资（红框），从 2421 亿增长至 4238 亿</figcaption>
</figure>
...
<br />
<figure className="flex flex-col items-center">
  <img src="/invest/income-statement/pdd2.png" alt="PDD 年度收入表" />
  <figcaption className="text-center text-sm text-gray-500 mt-2">PDD 年度收入表中的 Gain (Loss) on Sale of Investments 行</figcaption>
</figure>
...
<br />
<figure className="flex flex-col items-center">
  <img src="/invest/income-statement/nvda3.png" alt="NVDA Shares Outstanding" />
  <figcaption className="text-center text-sm text-gray-500 mt-2">英伟达流通股数变化：Diluted 从 24,890 微降至 24,483，Shares Change 为 -1.18%</figcaption>
</figure>
...
<br />
<figure className="flex flex-col items-center">
  <img src="/invest/income-statement/app1.png" alt="Apple Shares Outstanding" />
  <figcaption className="text-center text-sm text-gray-500 mt-2">苹果季度流通股数变化：从 16,030 减少到 15,406，减少了 3.89%</figcaption>
</figure>
...
<br />
<figure className="flex flex-col items-center">
  <img src="/invest/income-statement/apple2.png" alt="Apple Share Repurchase" />
  <figcaption className="text-center text-sm text-gray-500 mt-2">苹果 Cash Flow 表中的 Share Repurchase，最新一季度回购金额达 232 亿美金</figcaption>
</figure>
...
<br />
<figure className="flex flex-col items-center">
  <img src="/invest/income-statement/apple3.png" alt="Apple 年度 Shares Outstanding" />
  <figcaption className="text-center text-sm text-gray-500 mt-2">苹果年度流通股数：五年内从 18,471 减至 15,744，减少了 15.76%</figcaption>
</figure>
...
<br />
<figure className="flex flex-col items-center">
  <img src="/invest/income-statement/pdd3.png" alt="PDD Shares Outstanding" />
  <figcaption className="text-center text-sm text-gray-500 mt-2">PDD 五年流通股数变化：从 4,627 增至 5,416，公司通过增发股本筹集资金</figcaption>
</figure>
...
<br />
<figure className="flex flex-col items-center">
  <img src="/invest/income-statement/nvda-eps.png" alt="NVDA EPS" />
  <figcaption className="text-center text-sm text-gray-500 mt-2">英伟达 EPS：Diluted EPS 从 0.60 增长至 1.30，EPS Growth 达 66.67%</figcaption>
</figure>
...
<br />
<figure className="flex flex-col items-center">
  <img src="/invest/income-statement/nvda-emitda.png" alt="NVDA EBITDA" />
  <figcaption className="text-center text-sm text-gray-500 mt-2">英伟达 EBITDA 与 EBIT：因折旧摊销占比极小，两者差距不大</figcaption>
</figure>
...
<br />
<figure className="flex flex-col items-center">
  <img src="/invest/income-statement/xbk.png" alt="星巴克 EBITDA" />
  <figcaption className="text-center text-sm text-gray-500 mt-2">星巴克 EBITDA：折旧摊销高达 399M，重资产行业中 EBITDA 比 Net Income 更能反映经营能力</figcaption>
</figure>
